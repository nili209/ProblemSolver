...
class Main {
 public:
  ...
  //test2
  Searcher<Searchable<Point>*, string>* searcher2(new BestFirstSearch<Point>);
  ...
  //test3
  Searcher<Searchable<Point>*, string>* searcher3(new BestFirstSearch<Point>);
  initial_point = new Point(0,0);
  p01 = new Point(0,1);
  ...
  FileCacheManager<const char*>* my_cache = new FileCacheManager<const char*>(-1);
  ...
  cout<<my_cache->getSolution(problem1)<<endl;
    ...
    FileCacheManager<const char*> *my_cache2 = new FileCacheManager<const char*>(-1);
...
//  server_side::Server* server = new MySerialServer();
//  Solver<string, const char*>* string_reverser = new StringReverser();
//  ClientHandler* c = new MyTestClientHandler<string, const char*>(string_reverser, my_cache);
//  server->open(5402, c);
//  return 0;
//}